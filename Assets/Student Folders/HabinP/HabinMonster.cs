...
public class HabinMonster : HazardController
{
    ...
    {
        //get the rotation toward the player in 2d
        Vector2 direction2D = (PlayerController.Player.transform.position - transform.position).normalized;
        //make direction2D to a vector3
